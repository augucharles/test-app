import { C, Lucid, Blockfrost } from 'lucid-cardano';
...
var buildTimelockedNativeScript = function buildTimelockedNativeScript(slot, pkh) {
  var ns = C.NativeScripts["new"]();
  ns.add(C.NativeScript.new_timelock_start(C.TimelockStart["new"](C.BigNum.from_str(slot.toString()))));
  ns.add(C.NativeScript.new_script_pubkey(C.ScriptPubkey["new"](C.Ed25519KeyHash.from_hex(pkh))));
  var scriptAll = C.ScriptAll["new"](ns);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return Lucid["new"](new Blockfrost(blockfrostUrl, apiKey), network);
...
export default init;
//# sourceMappingURL=cardashift-lucid-contracts.esm.js.map
